...
namespace MedPod
{
    public class WorkGiver_DoctorCarryFromBedToMedPod : WorkGiver_DoctorRescueToMedPod
	{
		...
		public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
		{
			...
			if (bedMedPod != null && MedPodHealthAIUtility.ShouldSeekMedPodRest(patient, bedMedPod) && MedPodHealthAIUtility.HasAllowedMedicalCareCategory(patient) && patient.CanReserve(bedMedPod))
			{
				return true;
			}
			return false;
